...
pNut is a small altcoin for small people based on Primecoin.

The pNut particularity is to be no hashcash Proof-of-Work. You don't mine this coin by hashes, but throught a scientist algorithm.
nPut is for small peoples because you can mine it with your desktop, from a vps, or a laptop and still compete. 
Of course you produce more if your computer is powerful, or if you have many vps running.

pNut is a coin based on Primecoin.nPut is rare,
pNut is fast,
pNut is not premined,
pNut is for all,
pNut is ecologic,
pNut is wonderful,
that's crazy.

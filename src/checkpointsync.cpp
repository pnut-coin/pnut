...
//
// pNut also adopts this security mechanism, and the enforcement of
...
bool ResetSyncCheckpoint()
{
    ...
    if (!WriteSyncCheckpoint((mapBlockIndex.count(hash) && mapBlockIndex[hash]->IsInMainChain())? hash : GENESIS_BLOCK_HASH))
...
bool SetCheckpointPrivKey(std::string strPrivKey)
{
    ...
    checkpoint.hashCheckpoint = GENESIS_BLOCK_HASH;
